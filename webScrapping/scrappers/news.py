...
#from webScrapping.scrappers.bienalVenezia import bienalVenezia #pylint: disable=no-member
from webScrapping.scrappers.infoDesigners import infoDesigners #pylint: disable=no-member
...
def getNews():
    ...
    newsTitles = dicInfoDesigners["titles"]
    newsDescriptions = dicInfoDesigners["descriptions"]
    newsImages = dicInfoDesigners["images"]
    newsUrls = dicInfoDesigners["urls"]
